                ...
                <div className="position-absolute end-0 me-5 z-3">
                    ...
                    {!user ? (
                        <form className="d-flex nav-form">
                            <button type="button" className="btn btn-danger me-2" onClick={() => { this.handleModal('loginModal', true) }}>Login</button>
                    ...
                    >
                        <div>
                            ...
                            <div onClick={() => this.handleModal('loginModal', false)} className="close"><i className="bi bi-x-lg"></i></div>
                        </div>
